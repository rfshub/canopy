                ...
                <AreaChart data={history} margin={{ top: 5, right: 0, left: 0, bottom: 0 }}>
                  <defs>
                    <linearGradient id="downloadGradient" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="5%" stopColor="var(--green-color)" stopOpacity={0.4}/>
                      <stop offset="95%" stopColor="var(--green-color)" stopOpacity={0}/>
                    </linearGradient>
                    <linearGradient id="uploadGradient" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="5%" stopColor="var(--yellow-color)" stopOpacity={0.4}/>
                      <stop offset="95%" stopColor="var(--yellow-color)" stopOpacity={0}/>
                    </linearGradient>
                  </defs>
                  <Tooltip
                  ...
                  <Area type="monotone" dataKey="download" stroke="var(--green-color)" fill="url(#downloadGradient)" strokeWidth={2} isAnimationActive={false} dot={false} />
                  <Area type="monotone" dataKey="upload" stroke="var(--yellow-color)" fill="url(#uploadGradient)" strokeWidth={2} isAnimationActive={false} dot={false} />
                </AreaChart>
              </ResponsiveContainer>
            </div>
            <div className="grid grid-cols-2 gap-4">
